...
public:
	...
	LSM9DS1(interface_mode interface, uint8_t xgAddr, uint8_t mAddr, uint8_t bus);
	//LSM9DS1();
...
protected:	
	...
	uint8_t mReadByte(uint8_t subAddress, uint8_t bus);
	...
	uint8_t mReadBytes(uint8_t subAddress, uint8_t * dest, uint8_t count, uint8_t bus);
	
	// gWriteByte() -- Write a byte to a register in the gyroscope.
	// Input:
	//	- subAddress = Register to be written to.
	//	- data = data to be written to the register.
	void mWriteByte(uint8_t subAddress, uint8_t data, uint8_t bus);
	...
	uint8_t xgReadByte(uint8_t subAddress, uint8_t bus);
	...
	// Output: No value is returned, but the `dest` array will store
	// 	the data read upon exit.
	uint8_t xgReadBytes(uint8_t subAddress, uint8_t * dest, uint8_t count, uint8_t bus);
	
	// xmWriteByte() -- Write a byte to a register in the accel/mag sensor.
	// Input:
	//	- subAddress = Register to be written to.
	//	- data = data to be written to the register.
	void xgWriteByte(uint8_t subAddress, uint8_t data, uint8_t bus);
	...
	void initI2C(uint8_t address, uint8_t I2CBus);
	...
	//	- subAddress = The register to be written to.
	//	- data = Byte to be written to the register.
	void I2CwriteByte(uint8_t address, uint8_t subAddress, uint8_t data, uint8_t bus);
	...
	// Output:
	//	- The byte read from the requested address.
	uint8_t I2CreadByte(uint8_t address, uint8_t subAddress, uint8_t bus);
	...
	// Output: No value is returned by the function, but the registers read are
	// 		all stored in the *dest array given.
	uint8_t I2CreadBytes(uint8_t address, uint8_t subAddress, uint8_t * dest, uint8_t count, uint8_t bus);
};
